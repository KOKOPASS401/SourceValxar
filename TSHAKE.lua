--[[                                    Dev @hs_dc         
   _____    _        _    _    _____    Dev @hs_dc 
  |_   _|__| |__    / \  | | _| ____|   Dev @Hs_dc  
    | |/ __| '_ \  / _ \ | |/ /  _|     Dev @Hs_dc
    | |\__ \ | | |/ ___ \|   <| |___    Dev @Hs_dc
    |_||___/_| |_/_/   \_\_|\_\_____|   Dev @Hs_dc
              CH > @SourceValxar
--]]
...
sendContact(msg.chat_id_, msg.id_, 0, 1, nil, 9647707641864, "Source Valxar" , "", bot_id)
end
...
if text:match("^source$") or text:match("^اصدار$") or text:match("^الاصدار$") or text:match("^السورس$") or text:match("^سورس$") then
   ...
   local text =  [[
• <code>اهلا بك في سورس فلكسر</code> 🦁ֆ

• <code>المطورين</code> ⚜️:-
• <b>Source Valxar </b>

• <code>قناه السورس</code> ❇️:-
•<b> Channel</b> | @SourceValxar
